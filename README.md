...
Сваки push на грану `main` аутоматски:

1. проверава JavaScript, гради сајт и проверава све интерне везе;
2. објављује проверени артефакт на GitHub Pages;
3. потврђује да јавни сајт заиста враћа SHA новог commit-а и покреће мрежну
   проверу свих страница, ресурса и прилагођене 404 странице.

Гране и pull request-и се само граде и проверавају, без објављивања. Workflow
користи Node.js 24, pin-оване GitHub Actions верзије и Pages write дозволе само
у deployment job-у.
