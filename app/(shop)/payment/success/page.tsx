...
export const metadata = {
  title: `Plaćanje uspešno | ${storeName}`,
...
async function PaymentSuccessContent({
  ...
  return (
    <div className="container mx-auto py-8 px-4 lg:px-8">
      {/* Clear cart when this page mounts */}
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-success-light border border-success/20 rounded-2xl p-8 mb-6 text-center">
          ...
          <p className="text-lg text-text-muted">
            Vaša porudžbina je uspešno plaćena i obrađena.
          </p>
        </div>
        ...
        {/* Customer details */}
        <div className="bg-white border border-border rounded-xl p-6 mb-4">
          <h3 className="font-semibold text-text mb-4">Podaci o kupcu</h3>
        ...
        {order.items.length > 0 && (
          <div className="bg-white border border-border rounded-xl p-6 mb-4">
            <h3 className="font-semibold text-text mb-4">
              Artikli u porudžbini ({order.items.length})
            </h3>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="text-left text-text-muted border-b border-border">
                    ...
                    <th className="py-2 pr-4 text-center">Vel.</th>
        ...
        <div className="bg-primary-light border border-primary/20 rounded-xl p-6 mb-6">
          ...
          <ul className="text-sm text-text-muted space-y-2">
            <li className="flex items-start gap-2">
              ...
              <span>
                Potvrdni email je poslat na <strong>{customerEmail}</strong>
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-success mt-0.5 shrink-0" />
              <span>Vaša porudžbina je uspešno plaćena</span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-success mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-success mt-0.5 shrink-0" />
              <span>Očekujte dostavu u roku od 2-4 radna dana</span>
            </li>
          </ul>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Button variant="secondary" asChild>
            <Link href="/catalog">Nastavi kupovinu</Link>
          </Button>
        </div>
      </div>
    </div>
